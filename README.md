...
- **GitHub repository:** https://github.com/Adish-Sai-P-K/coxor
...
The included render.yaml describes a free Render web service. Create a Render account, connect the Adish-Sai-P-K/coxor repository, and deploy the blueprint. The free service may sleep when unused, but it is enough for a demo.
...
Coxor is also a responsive PWA. On Android, open the deployed site in Chrome and choose Add to Home screen. On iPhone/iPad, open it in Safari, tap Share, then Add to Home Screen. Windows and Mac users can continue using the normal browser website.
